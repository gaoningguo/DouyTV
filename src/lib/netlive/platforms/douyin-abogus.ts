/**
 * 抖音 ABogus 签名脚本 —— vendored from `pure_live/lib/core/scripts/douyin_sign.dart` `kABogus`。
 *
 * 调用：`new Function("params","userAgent",ABOGUS_SCRIPT + "
return getABogus(params, userAgent);")(p, ua)`。
 * 内含 RC4 / 自定义 RC4 链 / sm3-like 摘要 + base64 变形，纯字符串运算无外部依赖。
 */

export const ABOGUS_SCRIPT = `
